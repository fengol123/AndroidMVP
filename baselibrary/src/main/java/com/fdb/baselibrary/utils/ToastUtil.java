...
public class ToastUtil {
    ...
    public static void show(CharSequence message, int duration) {
        ...
        if (mToast == null)
            mToast = Toast.makeText(BaseApplication.getApp().getApplicationContext(),
                    message, duration);
    ...
    public static void s(@StringRes int msgId) {
        s(BaseApplication.getApp().getApplicationContext().getResources().getString(msgId));
    }
    ...
    public static void l(@StringRes int msgId) {
        l(BaseApplication.getApp().getApplicationContext().getResources().getString(msgId));
    }
}
